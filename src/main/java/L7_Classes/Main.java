...
public class Main {
    public static void main(String[] args) {
        ...
        //  Создаем объект класса Lesson7_HW_OOP.Teacher, используя конструктор по умолчанию
        ...
        //  Создаем объект класса Lesson7_HW_OOP.Student. Используем свой конструктор, принимающий на вход 3 параметра
