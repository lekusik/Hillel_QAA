...
//        static int	abs(int a)
        System.out.println("Модуль " + x + " = " + Math.abs(x));
//
...
//        static int	max(int a, int b)
        System.out.println("Из чисел " + x + " и "  + y + " большее: " + Math.max(x, y));
//
//        Returns the smaller of two int values.
//        static int	min(int a, int b)
        System.out.println("Из чисел " + x + " и "  + y + " меньшее: " + Math.min(x, y));
//
...
//        static double	ceil(double a)
        System.out.println("Округленное в большую сторону " + z + " = " + Math.ceil(z));
//
//        Returns the largest (closest to positive infinity) double value that is less than or equal to the argument and is equal to a mathematical integer.
//        static double	floor(double a)
        System.out.println("Округленное в меньшую сторону " + z + " = " + Math.floor(z));
//
...
//        static double	exp(double a)
        System.out.println("e в степени " + x + " = " + Math.exp(x));
//
//        Returns ex -1.
...
//        Returns the signum function of the argument; zero if the argument is zero, 1.0 if the argument is greater than zero, -1.0 if the argument is less than zero.
        double d = Math.ceil(Math.random()*100)-50.5; // рэндомное число от -49.5 до 50.5.
